...
// (2) At least ONE hidden field with a relevant name
    ...
    return {'pageSuspicious': pageSuspicious, 'inputs': all_inputs, 'count_suspicious': count_suspicious};
